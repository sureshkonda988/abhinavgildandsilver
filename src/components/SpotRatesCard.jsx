                        ...
                        {rates.spot.map((rate, idx) => {
                            ...
                            return (
                                <tr key={idx} className="hover:bg-slate-50 transition-colors group whitespace-nowrap">
                                    ...
                                    <td className={`py-3 px-3 md:py-4 md:px-4 text-[9px] md:text-[13px] font-black text-center font-poppins transition-colors duration-300 text-slate-900`}>{renderSymbol(symbol)}{fmt(rate.bid)}</td>
                                    <td className={`py-3 px-3 md:py-4 md:px-4 text-[9px] md:text-[13px] font-black text-center font-poppins group-hover:text-magenta-800 transition-all duration-300 text-slate-900`}>{renderSymbol(symbol)}{fmt(rate.ask)}</td>
