            ...
            <div className="flex flex-col gap-3">
                <div className="relative">
                    ...
                    <div className="flex flex-col gap-4">
                        {/* Gold Rates Table */}
                        <div className="flex flex-col w-[85%] min-w-[210px] md:max-w-[480px] max-w-[100%] ml-auto mr-4 md:mx-auto md:ml-auto md:mr-16">
                            <div className="gradient-luxury px-2 py-2 md:px-5 md:py-3 rounded-t-xl shadow-lg flex justify-between items-center text-white font-poppins font-black text-[10px] md:text-[16px] uppercase tracking-widest">
                                <span className="w-1/2 text-left px-2 md:px-5">PURITY</span>
                                <span className="w-1/2 text-right pr-2 md:pr-5 tracking-tight md:tracking-widest">10 Grams</span>
                            </div>
                                        ...
                                        {rates.ratesPagePurities.map((gold, idx) => {
                                            ...
                                            return (
                                                <tr key={idx} className="hover:bg-white/5 transition-colors group">
                                                    <td className="px-2 py-2 md:px-5 md:py-3 text-[14px] md:text-[20px] font-bold text-white whitespace-nowrap w-1/2">
                                                        {gold.name}
                                                    </td>
                                                    <td className="px-2 py-2 md:px-5 md:py-3 text-right whitespace-nowrap w-1/2">
                                                        <span
                                                            className={`font-bold text-[18px] md:text-[26px] ${getKaratClass()}`}
                                                        >
                        ...
                        {/* Navarsu / Kasu Table */}
                        <div className="flex flex-col w-[85%] min-w-[210px] md:max-w-[480px] max-w-[100%] ml-auto mr-4 md:mx-auto md:ml-auto md:mr-16 mt-6">
                            <div className="gradient-luxury px-2 py-2 md:px-5 md:py-3 rounded-t-xl shadow-lg flex justify-between items-center text-white font-poppins font-black text-[10px] md:text-[16px] uppercase tracking-widest">
                                <span className="w-1/2 text-left px-1 md:px-0">8 GRAMS</span>
                                <span className="w-1/2 text-right pr-2 md:pr-5">Navarsu / Kasu</span>
                            </div>
                            <div className="glass rounded-b-xl overflow-hidden shadow-luxury">
                                <table className="w-full text-left">
                                    <tbody className="divide-y divide-white/5">
                                        <tr className="hover:bg-white/5 transition-colors group">
                                            ...
                                            <td className="px-2 py-2 md:px-5 md:py-3 text-right whitespace-nowrap w-1/2">
                                                <span className={`font-bold text-[18px] md:text-[26px] ${getKaratClass()}`}>
