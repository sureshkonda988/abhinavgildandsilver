...
const AppLayout = () => {
  ...
  const criticalImages = React.useMemo(() => {
    return ['/logo.webp', '/bg-internal.webp', '/bg-ticker.webp', '/rates-header.webp', '/mobile-rates-header.webp', '/header-rates-desktop.webp'];
  }, []);
  ...
  return (
    ...
    >
      ...
      {!isAdminPage && (
        <>
          <div className={`flex flex-col w-full z-50 bg-transparent ${isHomePage ? 'sticky top-0' : 'relative lg:sticky lg:top-0'}`}>
            <Navigation />
            {isHomePage && (
            ...
            <section className="relative w-full bg-transparent overflow-hidden">
              <div className="flex flex-col">
                ...
                <motion.img
                  ...
                  transition={{ duration: 0.5 }}
                  loading="eager"
                  src={location.pathname === '/rates' ? "/rates-header.webp" : ['/alerts', '/videos'].includes(location.pathname) ? "/logo.webp" : "/header-rates-desktop.webp"}
          ...
          {isHomePage && (
            <div className="relative z-20 flex justify-center items-center gap-2 lg:gap-8 px-1 md:px-0 mt-2 md:-mt-2">
              ...
              <motion.img 
                ...
                alt="" 
                className="block absolute md:relative w-16 md:w-24 lg:w-36 h-auto object-contain drop-shadow-2xl -scale-x-100 -translate-y-22 -translate-x-20 md:translate-x-0 md:-translate-y-16 lg:-translate-y-32 right-0 md:right-auto z-20 [@media(max-height:650px)_and_(orientation:landscape)]:-translate-y-28 [@media(max-height:650px)_and_(orientation:landscape)]:-translate-x-32" 
              />
            </div>
          )}
        </>
