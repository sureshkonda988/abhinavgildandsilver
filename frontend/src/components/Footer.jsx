                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <Link to="/admin" className="flex items-center gap-3">
                            <img src="/logo.webp" alt="Abhinav Logo" className="w-12 h-12 object-contain" />
                    ...
                    <div className="flex flex-col gap-6 lg:items-end">
                        ...
                        <div className="flex flex-col items-center lg:items-end gap-4">
                            ...
                            >
                                <img src="/qr-code-location.webp" alt="Scan QR Location" className="w-24 h-24 object-contain transition-transform duration-500 group-hover:scale-110" />
                                <div className="absolute inset-0 bg-gold-400/10 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />
                            </a>
                    ...
                    <div className="flex items-center gap-8">
                        <div className="flex gap-4">
                            ...
                            <Link to="/admin" className="hover:opacity-80 transition-opacity">
                                <img src="/logo.webp" alt="Admin Login" className="w-10 h-10 object-contain grayscale hover:grayscale-0 transition-all" />
                            </Link>
                        </div>
